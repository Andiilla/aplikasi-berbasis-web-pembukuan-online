...
<div class="wrapper">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">Nanda</h3>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p>Keep it to yourself and stay calm.</p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <!-- /.user-block -->
                  <p>
                    jangan lupa bilang 'ya ges ya' hari ini!
                  </p>
                ...
                <div class="post clearfix">
                  ...
                  <!-- /.user-block -->
                  <p>
                    Jangan Lupa Update PUBG mu bentar di rumah. Season Baru mi cok!
                  </p>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">Kelompok 1</a>.</strong> All rights
    reserved.
  </footer>
