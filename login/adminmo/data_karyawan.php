            ...
            <div class="box-header">
              ...
              <tbody>
				...
				?>
                  ...
                  <td>
                      <a href="editk.php?id=<?php echo $d['id_karyawan']; ?>"  class="btn btn-block btn-primary"><span class="glyphicon glyphicon-pencil"></span>
                      <a href="hapusk.php?id=<?php echo $d['id_karyawan']; ?>" onclick ="return confirm('Ingin Menghapus Data?')">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="post" action="tambah_aksik.php">
          <div class="box-body">
            <div class="form-group">
			<label>ID Karyawan</label>
                  <input type="text" name="id_karyawan" class="form-control" placeholder="id baru" required>
                </div>
                <div class="form-group">
				...
				<div class="form-group">
                 <label>Upah</label>
                  <input type="number" name="upah" class="form-control" placeholder="upah" required>
                </div>
				</div>
          <!-- /.box-body -->
