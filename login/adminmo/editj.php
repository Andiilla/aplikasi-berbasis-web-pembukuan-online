...
<?php 
include "koneksi.php";
	$edit = mysqli_query($koneksi,"SELECT * FROM jurnal WHERE tanggal='$_GET[id]'");
while($d=mysqli_fetch_array($edit)){
?>
<form role="form" method="post" action="updatej.php">
          <div class="box-body">
            <div class="form-group">
              <label>Tanggal</label>
              <input type="date" name="tanggal" value="<?php echo $d['tanggal'];?>" class="form-control" placeholder="Masukkan Tanggal Baru" required>
            </div>
            <div class="form-group">
              <label>Keterangan</label>
              <input type="text" name="keterangan" value="<?php echo $d['keterangan'];?>" class="form-control" placeholder="Masukkan Keterangan" required>
            </div>
            <div class="form-group">
              <label>Debit</label>
              <input type="number" name="debit" value="<?php echo $d['debit'];?>" class="form-control" placeholder="Masukkan Debit" required>
            </div>
            <div class="form-group">
              <label>Kredit</label>
              <input type="number" name="kredit" value="<?php echo $d['kredit'];?>" class="form-control" placeholder="Masukkan Kredit" required>
            </div>
			<!-- /.box-body -->
