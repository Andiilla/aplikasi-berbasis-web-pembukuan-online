            ...
            <div class="box-header">
              ...
              <tbody>
				...
				?>
				  ...
				  <td>
                      <a href="editp.php?id=<?php echo $d['tanggal']; ?>"  class="btn btn-block btn-primary"><span class="glyphicon glyphicon-pencil"></span>
                      <a href="hapusp.php?id=<?php echo $d['tanggal']; ?>" onclick ="return confirm('Ingin Menghapus Data?')">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="post" action="tambah_aksip.php">
          <div class="box-body">
				<div class="form-group">
                 <label>Tanggal</label>
                  <input type="date" name="tanggal" class="form-control" placeholder="Tanggal Hari Ini" required>
                </div>
				<div class="form-group">
			     <label>Nominal</label>
                  <input type="number" name="nominal" class="form-control" placeholder="Pendapatan Hari Ini" required>
                </div>
	            <div class="form-group">
