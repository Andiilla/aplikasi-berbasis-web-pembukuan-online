...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
	...
	<a href="data_pemasukan.php">Kembali</a>
	<h3>Edit Data Pemasukan</h3>
<?php 
include "koneksi.php";
	$edit = mysqli_query($koneksi,"SELECT * FROM pemasukan WHERE tanggal='$_GET[id]'");
...
<form role="form" method="post" action="updatep.php">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="kegiatan" value="<?php echo $d['kegiatan'];?>" class="form-control" placeholder="Masukkan Keterangan" required>
            </div>
			<!-- /.box-body -->
