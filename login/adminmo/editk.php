...
<?php 
include "koneksi.php";
	$edit = mysqli_query($koneksi,"SELECT * FROM karyawan WHERE id_karyawan='$_GET[id]'");
while($d=mysqli_fetch_array($edit)){
?>
<form role="form" method="post" action="updatek.php">
          <div class="box-body">
            <div class="form-group">
              <label>ID Karyawan</label>
              <input type="number" name="id_karyawan" value="<?php echo $d['id_karyawan'];?>" class="form-control" placeholder="Masukkan ID Baru" required>
            </div>
            <div class="form-group">
              <label>Nama</label>
              <input type="text" name="nama_karyawan" value="<?php echo $d['nama_karyawan'];?>" class="form-control" placeholder="Masukkan Nama" required>
            </div>
            <div class="form-group">
              <label>Status</label>
              <input type="text" name="status" value="<?php echo $d['status'];?>" class="form-control" placeholder="Masukkan Status" required>
            </div>
            <div class="form-group">
              <label>jabatan</label>
              <input type="text" name="jabatan" value="<?php echo $d['jabatan'];?>" class="form-control" placeholder="Masukkan Jabatan" required>
            </div>
			<div class="form-group">
              <label>Upah</label>
              <input type="number" name="upah" value="<?php echo $d['upah'];?>" class="form-control" placeholder="Masukkan Upah" required>
            </div>
          <!-- /.box-body -->
