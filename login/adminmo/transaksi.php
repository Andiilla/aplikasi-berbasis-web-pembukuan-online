            ...
            <div class="box-header">
              ...
              <tbody>
				...
				?>
                  ...
                  <td>
                      <a href="editt.php?id=<?php echo $d['kegiatan']; ?>"  class="btn btn-block btn-primary"><span class="glyphicon glyphicon-pencil"></span>
                      <a href="hapust.php?id=<?php echo $d['kegiatan']; ?>" onclick ="return confirm('Ingin Menghapus Data?')">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="post" action="tambah_aksit.php">
          <div class="box-body">
