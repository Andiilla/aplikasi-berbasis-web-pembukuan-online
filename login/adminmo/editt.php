  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
		...
		<li><a href="calendar.html"><i class="glyphicon glyphicon-calendar"></i> <span>Kalendar</span></a></li>
...
<?php 
include "koneksi.php";
	$edit = mysqli_query($koneksi,"SELECT * FROM transaksi WHERE kegiatan='$_GET[id]'");
while($d=mysqli_fetch_array($edit)){
?>
<form role="form" method="post" action="updatet.php">
          <div class="box-body">
            <div class="form-group">
              <label>Kegiatan</label>
              <input type="text" name="kegiatan" value="<?php echo $d['kegiatan'];?>" class="form-control" placeholder="Masukkan Kegiatan" required>
            </div>
            <div class="form-group">
              <label>Tanggal</label>
              <input type="date" name="tanggal" value="<?php echo $d['tanggal'];?>" class="form-control" placeholder="Masukkan Tanggal Transaksi" required>
            </div>
            <div class="form-group">
              <label>Nominal</label>
              <input type="number" name="nominal" value="<?php echo $d['nominal'];?>" class="form-control" placeholder="Masukkan Nominal" required>
            </div>
			<!-- /.box-body -->
