...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
		...
		<li><a href="index.php?page=data_barang"><i class=" fa 
		fa-odnoklasaniki"></i> <span>Barang</span></a></li>
		<li><a href="index.php?page=data_karyawan"><i class=" fa 
		fa-odnoklasaniki"></i> <span>Karyawan</span></a></li>
		<li><a href="index.php?page=data_pemasukan"><i class=" fa 
		fa-odnoklasaniki"></i> <span>Pemasukan Harian</span></a></li>
		<li><a href="index.php?page=transaksi"><i class=" fa 
		fa-odnoklasaniki"></i> <span>Transaksi</span></a></li>
		<li><a href="index.php?page=jurnal"><i class=" fa 
		fa-odnoklasaniki"></i> <span>Jurnal</span></a></li>
		<li><a href="index.php?page=calender"><i class=" fa 
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">Kelompok1</a>.</strong> All rights
    reserved.
  </footer>
